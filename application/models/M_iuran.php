...
class M_iuran extends CI_Model {
    ...
    public function is_exist($id)
    {
        ...
        $this->db->where("`id`", $id);
        $count = $this->db->count_all_results("iuran");
    ...
    public function load_data($page, $perpage, $order_by, $search, $acc_level, $id_perusahaan)
    {
        ...
        $this->db->select("perusahaan.nama_perusahaan, iuran.*");
        ...
        if ($id_perusahaan) {
            $this->db->where("iuran.id_perusahaan", $id_perusahaan);
        }
        ...
        $this->db->join("perusahaan", "perusahaan.id = iuran.id_perusahaan", "right");
    ...
    public function insert($data)
    {
        ...
        $count = $this->db->insert("iuran", $data);
    ...
    public function update($data, $id)
    {
        ...
        $this->db->where("`id`", $id);
        $count = $this->db->update("iuran", $data);
