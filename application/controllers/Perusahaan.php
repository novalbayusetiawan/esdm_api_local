...
class Perusahaan extends CI_Controller {
    ...
    public function dt_show()
    {
		...
		$advanced_filter =$this->input->post_get("advanced_filter");
        ...
        if ( $valid ) {
            ...
            $total = $this->m_perusahaan->count_data($search, $acc_level, $filter, $advanced_filter);
            $result = $this->m_perusahaan->load_data($page, $perpage, $order_by, $search, $acc_level, $filter, $advanced_filter);
            $data = array(
                "draw" => 0,
                "recordsTotal" => $total,
